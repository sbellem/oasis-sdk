...
pub trait MethodHandler {
    ...
    /// only. A return value of None means that the implementor does not care to list the methods,
    /// or the implementor is a tuple of modules.
    fn supported_methods() -> Option<Vec<MethodHandlerInfo>> {
        None
    }
}
    ...
    fn module_info<C: Context>(ctx: &mut C) -> BTreeMap<String, ModuleInfo> {
        ...
        info.insert(
            ...
            ModuleInfo {
                ...
                params: cbor::to_vec(Self::params(ctx.runtime_state())),
